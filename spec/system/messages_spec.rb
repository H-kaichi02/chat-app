...
RSpec.describe 'メッセージ投稿機能', type: :system do
  ...
  context '投稿に成功したとき' do
    ...
    it '画像の投稿に成功すると、投稿一覧に遷移して、投稿した画像が表示されている' do
      ...
      # 送信した値がDBに保存されているとを確認する
      expect {find('input.form-submit').click;sleep 1}.to change { Message.count }.by(1)
    ...
    it 'テキストと画像の投稿に成功する' do
      ...
      # 送信した値がDBに保存されていることを確認する
      expect{find('input[name="commit"][type="submit"]').click;sleep 1}.to change {Message.count}.by(1)
